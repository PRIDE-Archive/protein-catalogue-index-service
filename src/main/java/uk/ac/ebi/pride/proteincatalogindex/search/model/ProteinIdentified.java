package uk.ac.ebi.pride.proteincatalogindex.search.model;
...
public class ProteinIdentified implements ProteinReferenceProvider, ProteinDetailProvider {
    ...
    //this sequence will not be available in the protein catalogue, only in the protein identification one
    @Override
